...
#define ACCESSORY_NAME  ("HOME_LED")
//#define ACCESSORY_SN  ("SN_880000")  //SERIAL_NUMBER
#define ACCESSORY_SN  ("SN_110009")  //SERIAL_NUMBER
#define ACCESSORY_MANUFACTURER ("WDKIOT")
#define ACCESSORY_MODEL  ("ESP8266")

#define PIN_LED  2//D4
#define PIN_LED2  4//实际输出的PWM引脚
